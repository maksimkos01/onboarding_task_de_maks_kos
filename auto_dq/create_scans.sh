...
gcloud dataplex datascans create data-quality mk-products-dq-scan \
    --location="$LOCATION" \
    --data-source-resource="$DATA_SOURCE_BASE/dim_products" \
    --data-quality-spec-file="rules/dq_products.yaml" 


gcloud dataplex datascans create data-quality mk-employee-dq-scan \
    --location="$LOCATION" \
...
gcloud dataplex datascans create data-quality mk-stores-dq-scan \
    --location="$LOCATION" \
